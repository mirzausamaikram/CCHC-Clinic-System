    ...
    <body>
        ...
        <form method="post" action="<%= request.getContextPath() %>/staff/queue">
            ...
            <select id="patientId" name="patientId" required>
                ...
                <% if (pList != null) {
                    for (PatientProfileBean patient : pList) { %>
                        <option value="<%= patient.getPatientId() %>"><%= patient.getFullName() %></option>
                <%  }
                } %>
            </select>
            ...
            <select id="clinicServiceId" name="clinicServiceId" required>
                ...
                <% if (csList != null) {
                    for (ClinicServiceBean clinicService : csList) {
                        ServiceBean service = sMap != null ? sMap.get(clinicService.getServiceId()) : null;
                %>
                        <option value="<%= clinicService.getClinicServiceId() %>">
                            <%= service != null ? service.getServiceName() : ("Service #" + clinicService.getServiceId()) %>
                            (<%= clinicService.getDurationMinutes() %> min)
                        </option>
                <%  }
                } %>
            </select>
